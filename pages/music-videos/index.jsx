              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="flex w-full min-w-80 flex-1 flex-col justify-center gap-2 text-balance px-4 pt-6 text-red md:gap-4 md:px-0 lg:min-w-80"
                  >
                    <h2 className="text-3xl tracking-tight text-red lg:text-5xl">
                      {project.videoTitle}
                    </h2>
                    <h3 className="min-w-64 text-xl leading-snug">
                      {project.artist}
                    </h3>
                  </motion.div>
                </div>
